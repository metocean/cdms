  ...
  public:
    ...
    protected:
      ...
      void testGetGRIB1Latitudes(void)
      {
        ...
        CPPUNIT_ASSERT_DOUBLE_ARRAYS_EQUAL(GRIB1_TEST_DATA_LATITUDES, latitudesRead, GRIB1_NLAT, 1.0e-3);
      }
      ...
      void testGetGRIB2Latitudes(void)
      {
        ...
        cudimget(fileId, latitudeDimensionId, latitudesRead);
        CPPUNIT_ASSERT(latitudesRead != 0);
        CPPUNIT_ASSERT_DOUBLE_ARRAYS_EQUAL(GRIB2_TEST_DATA_LATITUDES, latitudesRead, GRIB2_NLAT, 1.0e-3);
      }
      ...
      void testGetGRIB2Latitudes_2(void)
      {
        ...
        cudimget(fileId, latitudeDimensionId, latitudesRead);
        CPPUNIT_ASSERT(latitudesRead != 0);
        CPPUNIT_ASSERT_DOUBLE_ARRAYS_EQUAL(GRIB2_2_TEST_DATA_LATITUDES, latitudesRead, GRIB2_NLAT, 1.0e-3);
      }
      ...
      void testGetGRIB1GridData(void)
      {
        ...
        CPPUNIT_ASSERT_DOUBLE_2D_ARRAYS_EQUAL(GRIB1_TEST_DATA_T0, dataRead, GRIB1_NLON, GRIB1_NLAT, 1.0e-3);

        start[0]=1;
        cuvarget(fileId, variableId, start, count, dataRead);
        CPPUNIT_ASSERT_DOUBLE_2D_ARRAYS_EQUAL(GRIB1_TEST_DATA_T1, dataRead, GRIB1_NLON, GRIB1_NLAT, 1.0e-3);
      ...
      void testGetGRIB2GridData(void)
      {
        ...
        start[0]=13;
        cuvarget(fileId, variableId, start, count, dataRead);
        CPPUNIT_ASSERT_DOUBLE_2D_ARRAYS_EQUAL(GRIB2_TEST_DATA_T0, dataRead, GRIB2_NLON, GRIB2_NLAT, 1.0e-3);

        start[0]=14;
        cuvarget(fileId, variableId, start, count, dataRead);
        CPPUNIT_ASSERT_DOUBLE_2D_ARRAYS_EQUAL(GRIB2_TEST_DATA_T1, dataRead, GRIB2_NLON, GRIB2_NLAT, 1.0e-3);
